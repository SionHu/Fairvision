...
def prestep2():
    ...
    of code resets the database with new merges.
    '''
...
if __name__ == "__main__":
    ...
    parser.add_argument('step', type=int, nargs='?', default=3, choices=(3,), help='step to preprocess (the step that you are going to start)')
    parser.add_argument('-f', '--force', type=bool, metavar='force', default=False, help='Delete all content of next step if it exists.')
